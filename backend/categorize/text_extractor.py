...
- feeding extracted text to the text-LLM classifier for file types vision
  can't render (word/ppt/excel/csv) — see backend/categorize/classifier.py

document_type is decided entirely from actual content: vision for
PDFs/images, a text LLM for everything else. This module only extracts
text/TOC; it does not classify anything itself.
"""
