...
-- One row per Q&A turn (team shared schema). conversation_store.py maps the
-- role/content Protocol onto these columns. Keep in sync with PostgresConversationStore.
